...
export const SCRIPTS: ReadonlyArray<ScriptInfo> = [
  ...
  { id: 'arabic',     group: 'me',    nameIt: 'Arabo',        nameEn: 'Arabic',      region: 'Mondo arabo',      regionEn: 'Arab world',     lang: 'Arabo, Persiano, Urdu',      samples: 'اببتثجحخدذرزسشصضطظعغفقكلمنهوي', sample: 'ش', era: 'IV sec. d.C.', blurb: 'Scrittura cursiva da destra a sinistra. Quasi tutte le lettere cambiano forma a seconda della posizione (iniziale/mediale/finale/isolata).' },
